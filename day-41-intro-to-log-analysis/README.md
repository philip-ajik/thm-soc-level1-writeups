...
This room moves from the *why* of logging (covered in [Day 39](../day-39-intro-to-logs/README.md) and [Day 40](../day-40-log-operations/README.md)) into the actual mechanics of analysing a log file — first from the command line, then with regular expressions, and finally with CyberChef as a dedicated analysis tool.
